...
combo_destino.set(divisas[1]) # Establece el valor predetermindo
...
boton_convertir = tk.Button(ventana, text="Convertir", command=calcular_converion)
